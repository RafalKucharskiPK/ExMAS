...
setup(
    ...
    author_email='rafalkucharski.box _at_ gmail.com',  # Type in your E-Mail
    url='https://github.com/RafalKucharskiPK/',  # Provide either the link to your github or to your website
